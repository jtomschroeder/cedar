...
function setup() {
  ...
  // var post = (msg) => console.log("NYI - POST: " + msg);
  var post = (msg) => window.module.exports.process(1234, new_string(msg));
